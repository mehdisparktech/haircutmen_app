...
class AppColors {
  // Primary Color
  static const Color primaryColor = Color(0xFFFF7887);
  ...
  // Red alias for backward compatibility
  ...
  static const Color white600 = Color(0xFFE5E5E5);
  static const Color white700 = Color(0xFFCCCCCC);
  static const Color white800 = Color(0xFFB3B3B3);
